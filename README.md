...
Я рассчитал конверсию для контрольной и тестовой групп и сравнил их, затем проверил статистическую значимость результатов при помощи статистических гипотез и расчёта доверительного интервала.
